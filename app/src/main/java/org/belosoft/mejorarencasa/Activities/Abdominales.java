...
public class Abdominales extends AppCompatActivity {
    ...
    // Serie
    private static final String SERIE_TYPE = Util.STRING_ABDOMINALES;
    private static final int SERIE_REPETITIONS = 5;
    private static final int SERIE_ICON = R.drawable.abdominales2;
    private static final int SERIE_BACKGROUND = android.R.color.holo_blue_dark;
