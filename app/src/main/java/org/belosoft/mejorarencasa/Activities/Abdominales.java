...
public class Abdominales extends AppCompatActivity {
    ...
    // Serie
    private static final String SERIE_TYPE = "Abdominales";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // asignar el color
        viewChangeBackground.setBackgroundColor(getResources().getColor(android.R.color.holo_blue_dark));

        // imagen asociada
        ImageView imageView = (ImageView) findViewById(R.id.imageViewSerie);
        imageView.setImageResource(R.drawable.abdominales2);
