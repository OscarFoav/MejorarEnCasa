...
public class Dominadas extends AppCompatActivity {
    ...
    // Serie
    private static final String SERIE_TYPE = "Dominadas";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // asignar el color
        viewChangeBackground.setBackgroundColor(getResources().getColor(android.R.color.holo_orange_light));

        // imagen asociada
        ImageView imageView = (ImageView) findViewById(R.id.imageViewSerie);
        imageView.setImageResource(R.drawable.dominadas);
