...
public class Dominadas extends AppCompatActivity {
    ...
    // Serie
    private static final String SERIE_TYPE = Util.STRING_DOMINADAS;
    private static final int SERIE_REPETITIONS = 5;
    private static final int SERIE_ICON = R.drawable.dominadas;
    private static final  int SERIE_BACKGROUND = android.R.color.holo_green_dark;
