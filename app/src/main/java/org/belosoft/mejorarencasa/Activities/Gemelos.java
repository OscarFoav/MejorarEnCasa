...
public class Gemelos extends AppCompatActivity {
    ...
    // Serie
    private static final String SERIE_TYPE = "Gemelos";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // asignar el color
        viewChangeBackground.setBackgroundColor(getResources().getColor(android.R.color.holo_purple));

        // imagen asociada
        ImageView imageView = (ImageView) findViewById(R.id.imageViewSerie);
        imageView.setImageResource(R.drawable.gemelos2);
