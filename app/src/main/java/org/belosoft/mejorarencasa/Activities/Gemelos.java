...
public class Gemelos extends AppCompatActivity {
    ...
    // Serie
    private static final String SERIE_TYPE = Util.STRING_GEMELOS;
    private static final int SERIE_REPETITIONS = 5;
    private static final int SERIE_ICON = R.drawable.gemelos2;
    private static final  int SERIE_BACKGROUND = android.R.color.holo_purple;
