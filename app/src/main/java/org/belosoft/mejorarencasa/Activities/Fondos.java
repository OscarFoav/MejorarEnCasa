...
public class Fondos extends AppCompatActivity {
    ...
    // Serie
    private static final String SERIE_TYPE = "Fondos";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // asignar el color
        viewChangeBackground.setBackgroundColor(getResources().getColor(android.R.color.holo_green_dark));

        // imagen asociada
        ImageView imageView = (ImageView) findViewById(R.id.imageViewSerie);
        imageView.setImageResource(R.drawable.fondos2);
