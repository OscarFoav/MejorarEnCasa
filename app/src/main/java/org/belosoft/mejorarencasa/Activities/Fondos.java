...
public class Fondos extends AppCompatActivity {
    ...
    // Serie
    private static final String SERIE_TYPE = Util.STRING_FONDOS;
    private static final int SERIE_REPETITIONS = 5;
    private static final int SERIE_ICON = R.drawable.fondos2;
    private static final  int SERIE_BACKGROUND = android.R.color.holo_orange_light;
