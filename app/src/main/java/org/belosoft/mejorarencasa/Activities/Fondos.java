...
public class Fondos extends AppCompatActivity {
    ...
    public int repSerie1 = 17;
    public int repSerie2 = 17;
    public int repSerie3 = 17;
    public int repSerie4 = 15;
    public int repSerie5 = 15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txvFlexionesSeriesRepeticiones = (TextView) findViewById(R.id.txvFondosSeriesRepeticiones);
